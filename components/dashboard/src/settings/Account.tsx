    ...
    return <div>
        <Modal visible={modal} onClose={close}>
            ...
            <div className="flex justify-end mt-6">
                ...
                <button className={"ml-2 danger disabled:opacity-50" + (typedEmail !== primaryEmail ? ' hover:bg-red-600' : '')} onClick={deleteAccount} disabled={typedEmail !== primaryEmail}>Delete Account</button>
            </div>
        </Modal>
